...
class Window(QWidget):
    def __init__(self):
        ...
        self._connect_to_db()  ## подключение к базе

        self.vbox = QHBoxLayout(self) ## лейаут для выравнивания

        self.tabs = QTabWidget(self)  ## добавили виджеты
        ...
        self._create_shedule_tab1()
        self._create_shedule_tab2()
        self._create_shedule_tab3()
        self._create_shedule_tab4()
    ...
    def _create_teacher_tab(self):
        ...
        self.shbox1 = QVBoxLayout()  ## выравнивание по осям
    ...
    def _create_shedule_tab(self):
        ...
        self.monday_gbox = QGroupBox('Monday')  ## рамка для таблицы

        self.svbox = QVBoxLayout()
        self.shbox1 = QVBoxLayout()  ## выравнивание по осям
        self.shbox2 = QHBoxLayout()

        self.svbox.addLayout(self.shbox1) ## добавление 2х в 1
    ...
    def _create_shedule_tab1(self):
        self.tuesday_gbox = QGroupBox('Tuesday')  ## рамка для таблицы
    ...
    def _create_shedule_tab2(self):
        self.wednesday_gbox = QGroupBox('Wednesday')  ## рамка для таблицы
    ...
    def _create_shedule_tab3(self):
        self.thursday_gbox = QGroupBox('Thursday')  ## рамка для таблицы

        self.shbox1.addWidget(self.thursday_gbox)

        self._create_thursday_table()

    def _create_shedule_tab4(self):
        self.friday_gbox = QGroupBox('Friday')  ## рамка для таблицы
    ...
    def _update_t_table(self):
        self.cursor.execute("SELECT id, full_name, subject FROM list.teacher")
    ...
    def _update_sub_table(self):
        self.cursor.execute("SELECT id, name FROM list.subject")
        records = list(self.cursor.fetchall())
    ...
    def _update_monday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM list.timetable WHERE day = 'monday'")
        records = list(self.cursor.fetchall())
    ...
    def _update_tuesday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM list.timetable WHERE day = 'tuesday'")
        records = list(self.cursor.fetchall())
    ...
    def _update_wednesday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM list.timetable WHERE day = 'wednesday'")
        records = list(self.cursor.fetchall())
    ...
    def _update_thursday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM list.timetable WHERE day = 'thursday'")
        records = list(self.cursor.fetchall())
    ...
    def _update_friday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM list.timetable WHERE day = 'friday'")
        records = list(self.cursor.fetchall())
    ...
    def _change_data_from_t(self, rowNumb):
        ...
        print(row)
        try:
            self.cursor.execute("UPDATE list.teacher set full_name =%s, subject =%s WHERE id =%s",
    ...
    def _change_data_from_sub(self, rowNumb):
        ...
        print(row)
        try:
            self.cursor.execute("UPDATE list.subject set name =%s WHERE id =%s",
                                (str(row[1]), str(row[0])))
            self.conn.commit()
        except:
            QMessageBox.about(self, "Error", "Enter all fields")
    ...
    def _change_data_from_table(self, rowNumb):
        ...
        for i in range(self.monday_table.columnCount()):
            try:
                ...
                row.append(None)
        try:
            self.cursor.execute("UPDATE list.timetable set subject =%s,  room_numb =%s, start_time =%s WHERE id =%s",
    ...
    def _delete_data_from_t(self, rowNumb):
        ...
        print(row)
        self.cursor.execute(f"DELETE FROM list.teacher WHERE id = {row}")
        self.conn.commit()
    ...
    def _delete_data_from_sub(self, rowNumb):
        ...
        print(row)
        self.cursor.execute(f"DELETE FROM list.subject WHERE id = {row}")
        self.conn.commit()
    ...
    def _delete_data_from_table(self, rowNumb):
        ...
        print(row)
        self.cursor.execute(f"DELETE FROM list.timetable WHERE id = {row}")
        self.conn.commit()
    ...
    def _delete_data_from_table2(self, rowNumb):
        row = self.wednesday_table.item(rowNumb, 0).text()
        print(row)
        self.cursor.execute(f"DELETE FROM list.timetable WHERE id = {row}")
        self.conn.commit()
    ...
    def _add_t(self, rowNumb):
        ...
        print(row[1])
        try:
            self.cursor.execute("INSERT INTO list.teacher (full_name, subject) values (%s, %s)", (str(row[1]), str(row[2])))
            self.conn.commit()
        except:
            QMessageBox.about(self, "Error", "Enter all fields")
        self._update_t_table()
    ...
    def _add_sub(self, rowNumb):
        ...
        print(row[1])
        try:
            self.cursor.execute("INSERT INTO list.subject (name) values (%s)", (str(row[1])))
            self.conn.commit()
        except:
            QMessageBox.about(self, "Error", "Enter all fields")
        self._update_sub_table()
    ...
    def _add_data(self, rowNumb):
        ...
        print(row)
        try:
            self.cursor.execute("INSERT INTO list.timetable (day, subject, room_numb, start_time) values ('monday', %s, %s, %s)",
    ...
    def _add_data1(self, rowNumb):
        ...
        print(row)
        try:
            self.cursor.execute("INSERT INTO list.timetable (day, subject, room_numb, start_time) values ('tuesday', %s, %s, %s)",
                                (str(row[1]), str(row[2]), str(row[3])))
            self.conn.commit()
        except:
            QMessageBox.about(self, "Error", "Enter all fields")
    ...
    def _add_data2(self, rowNumb):
        ...
        print(row)
        try:
            self.cursor.execute("INSERT INTO list.timetable (day, subject, room_numb, start_time) values ('wednesday', %s, %s, %s)",
                                (str(row[1]), str(row[2]), str(row[3])))
            self.conn.commit()
        except:
            QMessageBox.about(self, "Error", "Enter all fields")
    ...
    def _add_data3(self, rowNumb):
        ...
        print(row)
        try:
            self.cursor.execute("INSERT INTO list.timetable (day, subject, room_numb, start_time) values ('thursday', %s, %s, %s)",
                                (str(row[1]), str(row[2]), str(row[3])))
            self.conn.commit()
        except:
            QMessageBox.about(self, "Error", "Enter all fields")
    ...
    def _add_data4(self, rowNumb):
        ...
        print(row)
        try:
            self.cursor.execute("INSERT INTO list.timetable (day, subject, room_numb, start_time) values ('friday', %s, %s, %s)",
                                (str(row[1]), str(row[2]), str(row[3])))
            self.conn.commit()
        except:
            QMessageBox.about(self, "Error", "Enter all fields")
