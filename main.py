...
class MainWindow(QWidget):
    ...
    def _create_teachers_table(self, gbox):
        ...
        table.setHorizontalHeaderLabels(["ID", "Name", "Place", "Update"])

        table.setRowCount(len(self.teachers_names))
    ...
    def _create_table(self, table, gbox, weekday):
        ...
        table.setHorizontalHeaderLabels(["Subject", "Time", "Teacher", "Where", "Add", "Delete"])
